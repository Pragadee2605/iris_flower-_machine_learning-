...
import com.example.flower.ml.Iris
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener(View.OnClickListener {
            var ed1: EditText = findViewById(R.id.editTextNumberDecimal1)
...
// Runs model inference and gets result.
            ...
            tv.setText("setosa"+outputFeature0[0].toString()+"\n versicolor"+outputFeature0[1].toString()+"\n virginica"+outputFeature0[2].toString())
